...
function demoSeed(): Tables {
  ...
  const customers = [
    ...
    },
    {
      ...
      alt_phone: "",
      nin: "CF88112207JQPD",
      location: "Ntinda, Stretcher Road",
      residence: "Ntinda, above the bar",
      occupation: "Bar and lodge operator",
      guarantor_name: "",
      guarantor_phone: "",
      credit_limit: 0,
    ...
    },
    {
      ...
      alt_phone: "",
      nin: "",
      location: "Kampala Road, arcade B",
      residence: "",
      occupation: "Canteen",
      guarantor_name: "",
      guarantor_phone: "",
